...
public final class AcolyteArmorItem extends LivingArmorGeoItem implements KnowledgeReader, ItemTooltipStyleProvider {
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag isAdvanced) {
		...
		tooltip.addAll(ClientTextUtil.splitLinesByNewLine(ComponentUtil.literal(" ").append(TextComponentUtil.getAbilityText("bio_alchemical_epidermis.desc")).withStyle(ChatFormatting.DARK_GRAY)));
