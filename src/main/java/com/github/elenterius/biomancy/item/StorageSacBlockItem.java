...
public class StorageSacBlockItem extends BlockItem implements ItemTooltipStyleProvider {
	...
	public static Optional<ItemHandlerWrapper> getItemHandler(ItemStack stack) {
		return Optional.of(new ItemHandlerWrapper(ItemStackInventory.create(StorageSacBlockEntity.SLOTS, 64, stack, ItemStackInventory.InventorySerializer.CONTAINER).getItemHandler()));
	}
