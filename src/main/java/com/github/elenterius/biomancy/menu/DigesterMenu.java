...
public class DigesterMenu extends PlayerContainerMenu {
	...
	private boolean mergeIntoInputZone(ItemStack stackInSlot) {
		if (((com.github.elenterius.biomancy.crafting.recipe.SimpleRecipeType.AdvancedRecipeType<?>) DigesterBlockEntity.RECIPE_TYPE.get()).getFirstRecipeForIngredient(level, stackInSlot).isPresent()) {
