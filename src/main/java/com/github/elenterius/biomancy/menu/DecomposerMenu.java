...
public class DecomposerMenu extends PlayerContainerMenu {
	...
	private boolean mergeIntoInputZone(ItemStack stackInSlot) {
		if (((com.github.elenterius.biomancy.crafting.recipe.SimpleRecipeType.AdvancedRecipeType<?>) DecomposerBlockEntity.RECIPE_TYPE.get()).getFirstRecipeForIngredient(level, stackInSlot).isPresent()) {
