...
public class BioLabMenu extends PlayerContainerMenu {
	...
	private boolean mergeIntoInputZone(ItemStack stackInSlot) {
		if (((com.github.elenterius.biomancy.crafting.recipe.SimpleRecipeType.AdvancedRecipeType<?>) BioLabBlockEntity.RECIPE_TYPE.get()).getFirstRecipeForIngredient(level, stackInSlot).isPresent()) {
