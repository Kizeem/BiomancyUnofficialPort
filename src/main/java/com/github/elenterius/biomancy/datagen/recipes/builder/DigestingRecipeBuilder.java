...
public final class DigestingRecipeBuilder implements RecipeBuilder<DigestingRecipeBuilder> {
	...
	public void save(RecipeOutput output) {
		...
		advancement.parent(ResourceLocation.parse("recipes/root")).addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(recipeId)).rewards(AdvancementRewards.Builder.recipe(recipeId)).requirements(AdvancementRequirements.Strategy.OR);
		...
		StaticDigestingRecipe recipe = new StaticDigestingRecipe(recipeId, recipeResult.toStack(), craftingTimeTicks, craftingCostNutrients, recipeIngredient);
