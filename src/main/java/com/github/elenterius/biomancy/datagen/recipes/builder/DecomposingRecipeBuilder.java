...
public final class DecomposingRecipeBuilder implements RecipeBuilder<DecomposingRecipeBuilder> {
	...
	public DecomposingRecipeBuilder setIngredient(DatagenIngredient ingredient) {
		setIngredient(ingredient.toIngredient(), 1, BiomancyMod.rl(ingredient.resourceLocation.getNamespace() + "_" + ingredient.resourceLocation.getPath()));
		return this;
	}
	...
	public void save(RecipeOutput output) {
		...
		DecomposingRecipe recipe = new DecomposingRecipe(recipeId, outputs, ingredientStack, craftingTimeTicks, craftingCostNutrients);
