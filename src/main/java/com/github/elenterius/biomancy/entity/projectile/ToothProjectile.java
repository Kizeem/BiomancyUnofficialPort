...
public class ToothProjectile extends BaseProjectile implements ItemSupplier {
	...
	protected void onHitEntity(EntityHitResult result) {
		...
		if (shooter instanceof LivingEntity livingEntity && !level().isClientSide) {
			net.minecraft.world.item.enchantment.EnchantmentHelper.doPostAttackEffectsWithItemSource((net.minecraft.server.level.ServerLevel) level(), victim, ModDamageSources.toothProjectile(level(), this, shooter), livingEntity.getWeaponItem());
		}
	...
	private static final Supplier<ItemStack> ITEM_TO_RENDER = Lazy.of(() -> new ItemStack(ModItems.MOB_FANG.get()));
