...
public abstract class EaterFleshBlob extends FleshBlob implements FoodEater {
	...
	public static final Predicate<ItemEntity> ITEM_ENTITY_FILTER = itemEntity -> FindItemGoal.ITEM_ENTITY_FILTER.test(itemEntity) && itemEntity.getItem().has(net.minecraft.core.component.DataComponents.FOOD);
	...
	public boolean canPickUpLoot() {
		...
		return (heldStack.isEmpty() || !heldStack.has(net.minecraft.core.component.DataComponents.FOOD)) && super.canPickUpLoot();
	}
	...
	public boolean canHoldItem(ItemStack stack) {
		ItemStack heldStack = getFoodItem();
		return stack.has(net.minecraft.core.component.DataComponents.FOOD) && (heldStack.isEmpty() || !heldStack.has(net.minecraft.core.component.DataComponents.FOOD));
	}
