...
public interface IgnoreEntityCollisionPredicate {
	...
	IgnoreEntityCollisionPredicate IS_ALIVE_MOB = (state, level, pos, entity) -> entity instanceof LivingEntity livingEntity && !entity.getType().is(ModEntityTags.C_GOLEMS) && !entity.getType().is(EntityTypeTags.UNDEAD);
	IgnoreEntityCollisionPredicate IS_UNDEAD_MOB = (state, level, pos, entity) -> entity instanceof LivingEntity livingEntity && entity.getType().is(EntityTypeTags.UNDEAD);
