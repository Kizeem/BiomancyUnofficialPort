...
public class BloomberryProjectileRenderer extends GeoEntityRenderer<BloomberryProjectile> {
	...
	@Override
	public void actuallyRender(PoseStack poseStack, BloomberryProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
