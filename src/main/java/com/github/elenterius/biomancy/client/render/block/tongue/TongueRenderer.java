...
public class TongueRenderer extends CustomGeoBlockRenderer<TongueBlockEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TongueBlockEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
	...
	@Override
	public void renderRecursively(PoseStack poseStack, TongueBlockEntity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
