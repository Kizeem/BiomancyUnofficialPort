...
public final class GuiRenderUtil {
	...
	public static void drawAttackIndicator(GuiGraphics guiGraphics, int x, int y, float pct) {
		...
		guiGraphics.blitSprite(CROSSHAIR_ATTACK_INDICATOR_PROGRESS_SPRITE, 16, 4, 0, 0, x, y, (int) (pct * 17f), 4);
	...
	private static void drawQuad(Matrix4f matrix4f, int minX, int minY, int maxX, int maxY, int z, int argbColor) {
		...
		bufferbuilder.addVertex(matrix4f, (float) minX, (float) maxY, (float) z).setColor(argbColor);
		bufferbuilder.addVertex(matrix4f, (float) maxX, (float) maxY, (float) z).setColor(argbColor);
		bufferbuilder.addVertex(matrix4f, (float) maxX, (float) minY, (float) z).setColor(argbColor);
		bufferbuilder.addVertex(matrix4f, (float) minX, (float) minY, (float) z).setColor(argbColor);
