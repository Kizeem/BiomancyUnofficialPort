...
public class AcidSpitProjectileRenderer extends EntityRenderer<AcidSpitProjectile> {
	...
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("textures/entity/llama/spit.png");
	...
	public void render(AcidSpitProjectile entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
		...
		model.renderToBuffer(poseStack, buffer.getBuffer(model.renderType(TEXTURE)), packedLight, OverlayTexture.NO_OVERLAY, 0xFF000000 | rgb);
