...
public class TintedFluidType extends FluidType {
	...
	protected static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("block/water_still");
	protected static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("block/water_flow");
	protected static final ResourceLocation OVERLAY_TEXTURE = ResourceLocation.parse("block/water_overlay");
	protected static final ResourceLocation INSIDE_FLUID_TEXTURE = ResourceLocation.parse("textures/block/water_overlay.png");
