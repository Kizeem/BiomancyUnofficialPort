...
public final class SelfFeedingEnchantment {

	private SelfFeedingEnchantment() {}

	public static void repairLivingItems(Player player) {
		List<Map.Entry<EquipmentSlot, ItemStack>> enchantedItems = EnchantmentUtil.getItemsWithEnchantment(ModEnchantments.SELF_FEEDING, player, LivingTool.NEED_NUTRIENTS_PREDICATE);
	...
	protected static ItemStack getBestRepairItem(Player player, int neededRepairValue) {
