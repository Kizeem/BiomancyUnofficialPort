...
public final class Fonts {
	...
	//	public static final ResourceLocation ILLAGER_RUNES = ResourceLocation.fromNamespaceAndPath("minecraft", "illageralt");
	//	public static final ResourceLocation STANDARD_GALACTIC_ALPHABET = ResourceLocation.fromNamespaceAndPath("minecraft", "alt");
