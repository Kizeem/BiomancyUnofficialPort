...
public abstract class RecipeCraftingStateData<T extends ProcessingRecipe> implements ContainerData {
	...
	protected @Nullable T craftingGoalRecipe;
	...
	public Optional<T> getCraftingGoalRecipe(Level level) {
		if (craftingGoalRecipe != null) {
			return Optional.of(craftingGoalRecipe);
		}
	...
	public void setCraftingGoalRecipe(T recipe, RecipeInput inputInventory) {
		craftingGoalRecipe = recipe;
