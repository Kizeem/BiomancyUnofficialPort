...
public final class ModBlockSetTypes {
	public static final Supplier<BlockSetType> FLESH_SET_TYPE = () -> new BlockSetType("flesh", true, true, false, BlockSetType.PressurePlateSensitivity.EVERYTHING, ModSoundTypes.FLESH_BLOCK,
