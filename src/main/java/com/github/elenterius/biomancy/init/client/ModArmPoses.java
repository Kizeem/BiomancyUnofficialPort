...
public final class ModArmPoses {
	...
	// the enum constant BIOMANCY_HOLD_AND_AIM_GUN_TWO_HANDED is added to HumanoidModel.ArmPose at runtime via META-INF/enumextensions.json
	...
	public static HumanoidModel.ArmPose holdAndAimGunTwoHanded() {
		return HOLD_AND_AIM_GUN_TWO_HANDED_PROXY.getValue();
	}
