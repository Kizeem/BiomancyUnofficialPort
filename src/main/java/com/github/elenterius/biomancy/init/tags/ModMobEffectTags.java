...
public final class ModMobEffectTags {
	...
	public static boolean isNotRemovableWithCleansingSerum(MobEffect mobEffect) {
		return BuiltInRegistries.MOB_EFFECT.wrapAsHolder(mobEffect).is(NOT_REMOVABLE_WITH_CLEANSING_SERUM);
	}

	public static boolean isCradleLifeEnergySource(MobEffect mobEffect) {
		return BuiltInRegistries.MOB_EFFECT.wrapAsHolder(mobEffect).is(CRADLE_LIFE_ENERGY_SOURCE);
	}

	public static boolean isCradleDiseaseSource(MobEffect mobEffect) {
		return BuiltInRegistries.MOB_EFFECT.wrapAsHolder(mobEffect).is(CRADLE_DISEASE_SOURCE);
	}

	public static boolean isCradleSuccessSource(MobEffect mobEffect) {
		return BuiltInRegistries.MOB_EFFECT.wrapAsHolder(mobEffect).is(CRADLE_SUCCESS_SOURCE);
	}

	public static boolean isCradleHostilitySource(MobEffect mobEffect) {
		return BuiltInRegistries.MOB_EFFECT.wrapAsHolder(mobEffect).is(CRADLE_HOSTILITY_SOURCE);
	}

	public static boolean isCradleAnomalySource(MobEffect mobEffect) {
		return BuiltInRegistries.MOB_EFFECT.wrapAsHolder(mobEffect).is(CRADLE_ANOMALY_SOURCE);
	}

	public static boolean forgeIsAcid(MobEffect mobEffect) {
		return BuiltInRegistries.MOB_EFFECT.wrapAsHolder(mobEffect).is(FORGE_IS_ACID);
	}
