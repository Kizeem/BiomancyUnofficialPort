...
public final class ModItemTags {
	...
	public static final TagKey<Item> ENCHANTABLE_DESPOIL = tag("enchantable/despoil");
	public static final TagKey<Item> ENCHANTABLE_LIVING_TOOLS = tag("enchantable/living_tools");
	public static final TagKey<Item> ENCHANTABLE_SYRINGES = tag("enchantable/syringes");
	public static final TagKey<Item> ENCHANTABLE_SURGERY = tag("enchantable/surgery");
	public static final TagKey<Item> ENCHANTABLE_GUNS = tag("enchantable/guns");
